...
class part3_topo(Topo):
  def build(self):
    ...
    self.addLink(h10, s1,port2 = 1)
    self.addLink(h20, s2,port2 = 1)
    self.addLink(h30, s3,port2 = 1)

    self.addLink(s1, cores21,port1 = 2,port2 = 1)
    self.addLink(s2, cores21,port1 = 2,port2 = 2)
    self.addLink(s3, cores21,port1 = 2,port2 = 3)

    self.addLink(cores21, hnotrust,port1 = 4)
    self.addLink(cores21, dcs31,port1 = 55,port2 = 22)
    self.addLink(dcs31, serv1,port1 = 1)
